...
TODO: explain above, add table with properties, show how to enable new format, show new format


== OpenTelemetry Integration

NOTE: The OpenTelemetry integration in SDK 3.1 is marked as volatile and as a result may and will change in future versions.
...
NOTE: The OpenTracing integration in SDK 3.1 is marked as volatile and as a result may and will change in future versions.
